...
function Hero() {
  return (
    <main
      ...
      <div className="relative z-10 w-auto max-w-screen-xl flex flex-col items-center gap-10 px-4 mb-10 text-center">
        <h1 className="text-white mb-6 md:mb-12 lg:mb-24 font-barlow font-semibold leading-tight flex flex-col items-center text-center">
          <span className="text-[45px] md:text-[65px] lg:text-[65px] xl:text-[78px] mb-4">
            Innovate with
          </span>
          <div className="relative w-full max-w-[250px] sm:max-w-[300px] md:max-w-[400px] lg:max-w-[450px] mb-4">
            <Image
              src='/images/WGTS.png'
              alt='WGTS'
              width={500}
