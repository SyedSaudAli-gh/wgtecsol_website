...
const services = [
  {
    ...
    description: `At Squareup, our design team is passionate about creating
  ...
  return (
    <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
      {services.map((service, idx) => (
        <div key={idx} className="flex flex-col justify-between p-6 bg-[#1f1f1f] rounded-xl h-full">
